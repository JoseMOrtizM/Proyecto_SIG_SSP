<?php
	...
	$consulta="SELECT *	FROM `reales_adicional` ORDER BY `ID`";
	$resultados=mysqli_query($conexion,$consulta);
	$i=0;
...
<head>
	...
	<title>SIG-SSP: BD-Real Adic</title>
</head>
<body>
	...
	<section class="container-fluid px-5 mt-2 mb-5">
			...
			<div class="col-md-12 col-lg-9 mx-auto">
				<div class="row mt-4 align-items-center">
					<div class="col-md-9 mb-1">
						<h3 class="text-center text-md-left" title="Insertar nuevo renglón de actividad adicional realizada dentro del Plan"><span class="text-danger fa fa-cog fa-spin "></span> Insertar Real-Adicional:</h3>
					</div>
					<div class="col-md-3 text-center text-md-right mb-1">
						<a href="CRUD_reales_adicional.php" class="btn btn-danger text-light p-1"><span class="fa fa-reply-all"></span> Volver</a>
					</div>
				</div>
				<form action="CRUD_reales_adicional.php" method="post" class="text-center bg-dark p-2 rounded">
					...
					<div class="row">
						...
						<div class="col-6">
							<div class="input-group">
								<span class="input-group-text fa w-100 rounded-0 text-left">¿Aprobado?</span>
					...
					<div class="m-auto">
						<a href="CRUD_reales_adicional.php" class="btn btn-danger text-light"><span class="fa fa-reply-all"></span> Volver</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Insertar Nuevo Renglón &raquo;" class="btn btn-danger">
					</div>
				</form>
			</div>
		<?php
		...
		?>
			<div class="col-md-12 col-lg-9 mx-auto">
				<div class="row mt-4 align-items-center">
					<div class="col-md-9 mb-1">
						<h3 class="text-center text-md-left" title="Modificar un renglón de actividad adicional realizada dentro del Plan"><span class="text-danger fa fa-cog fa-spin "></span> Modificar Real-Adicional:</h3>
					</div>
					<div class="col-md-3 text-center text-md-right mb-1">
						<a href="CRUD_reales_adicional.php" class="btn btn-danger text-light p-1"><span class="fa fa-reply-all"></span> Volver</a>
					</div>
				...
				<form action="CRUD_reales_adicional.php" method="post" class="text-center bg-dark p-2 rounded">
					...
					<div class="row">
						<div class="col-6">
								<span class="input-group-text w-100 rounded-0">Unidad:</span>
								<input type="text" class="form-control col mb-2 rounded-0 w-100" name="unidad" id="unidad" placeholder="Unidad Real" required autocomplete="off" title="Modifique la Unidad asociadaa esta actividad" value="<?php echo $datos_a_actualizar["UNIDAD"]; ?>">
						</div>
						<div class="col-6">
							<div class="input-group">
								<span class="input-group-text w-100 rounded-0">Cantidad:</span>
								<input type="number" class="form-control col mb-2 rounded-0" name="cantidad" id="cantidad" placeholder="Año del ejercicio" required autocomplete="off" title="Modifique la cantidad de Unidades reales que desea reportar" min="0" value="<?php echo $datos_a_actualizar["CANTIDAD"]; ?>">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-6">
							<div id="click01" class="input-group date pickers mb-2">
								<span class="input-group-text fa fa-calendar w-100 text-left rounded-0"> Fecha de Culminación</span>
								<input id="datepicker01" type='text' class="form-control text-center rounded-0" name="fecha_actividad" placeholder="(Y-m-d)" required autocomplete="off" title="Modifique la Fecha de Culminación de la Actividad (Y-m-d)" value="<?php echo $datos_a_actualizar["FECHA_ACTIVIDAD"]; ?>">
							</div>
							<script type="text/javascript">
								$('#datepicker01').click(function(){
									Calendar.setup({
					...
					<div class="m-auto">
						<a href="CRUD_reales_adicional.php" class="btn btn-danger text-light"><span class="fa fa-reply-all"></span> Volver</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Modificar Renglón &raquo;" class="btn btn-danger">
					</div>
				</form>
			</div>
		<?php
		...
		?>
				<META HTTP-EQUIV="Refresh" CONTENT="0; URL=CRUD_reales_adicional.php">
		<?php
			}
		...
		<div class="card mb-3">
			<div class="card-header text-center bg-transparent">
				<h3 class='text-center'><span class="text-danger fa fa-cog fa-spin"></span> Estas son las Actividades Adicionales existentes en el sitio:</h3>
			</div>
					...
					<table class="table table-bordered table-hover" id="dataTable01">
						<thead>
							<tr class="text-center">
								...
								<th class="align-middle h5 p-0"><a title="Insertar" href="CRUD_reales_adicional.php?NA_Accion=insertar" class="h3 btn btn-transparent text-primary fa fa-share-square-o"><br>Insertar</a></th>
							</tr>
						</thead>
						<tbody>
							<?php
							...
							<tr>
								...
								<td class="text-center h5"><a title="Modificar" href="CRUD_reales_adicional.php?NA_Accion=actualizar&NA_Id=<?php echo $datos['ID'][$i]; ?>" class="h3 btn btn-transparent text-success fa fa-edit d-inline"></a>&nbsp;&nbsp;<a title="Eliminar" href="CRUD_reales_adicional.php?NA_Accion=borrar&NA_Id=<?php echo $datos['ID'][$i]; ?>" class="btn btn-transparent text-danger fa fa-trash-o d-inline" onclick="return confirmar<?php echo $i; ?>('CRUD_reales_adicional?NA_Accion=borrar&NA_Id=<?php echo $datos['ID'][$i]; ?>')"></a></td>
								<script>
