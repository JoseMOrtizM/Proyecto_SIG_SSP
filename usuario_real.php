<?php
	...
	FROM `reales` INNER JOIN `planes` ON `reales`.`ID_PLAN`=`planes`.`ID` 
...
<head>
	...
	<title>SIG-SSP: Real-<?php echo $usuario_nombre;?></title>
</head>
<body>
	...
	<section class="container-fluid px-5 mt-2 mb-5">
			...
			<div class="col-md-12 col-lg-9 mx-auto">
				<div class="row mt-4 align-items-center">
					<div class="col-md-9 mb-1">
						<h3 class="text-center text-md-left" title="Insertar nuevo renglon real para una meta del Plan"><span class="text-danger fa fa-cog fa-spin "></span> Insertar Renglón-Real:</h3>
					</div>
					<div class="col-md-3 text-center text-md-right mb-1">
						<a href="usuario_real.php" class="btn btn-danger text-light p-1"><span class="fa fa-reply-all"></span> Volver</a>
					</div>
				</div>
				<form action="usuario_real.php" method="post" class="text-center bg-dark p-2 rounded">
					...
					<div class="input-group">
						...
						<select name="id_plan" id="id_plan" class="form-control mb-2 text-left rounded-0" required title="Elija el Año-Cargo-Descripción_Unidad asociada a la actividad que desea reportar" autocomplete="off">
							<option></option>
							<?php
								$consulta_i="SELECT `ID`, `CARGO`, `DESCRIPCION`, `ANO`, `UNIDAD` FROM `planes` WHERE `CARGO`='$usuario_cargo' ORDER BY `ANO`, `CARGO`, `DESCRIPCION`, `UNIDAD`, `ID`";
					...
					<div class="m-auto">
						<a href="usuario_real.php" class="btn btn-danger text-light"><span class="fa fa-reply-all"></span> Volver</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Insertar Nuevo Renglón &raquo;" class="btn btn-danger">
					</div>
				</form>
			</div>
		<?php
		...
		?>
			<div class="col-md-12 col-lg-9 mx-auto">
				<div class="row mt-4 align-items-center">
					<div class="col-md-9 mb-1">
						<h3 class="text-center text-md-left" title="Modificar renglon real para una meta del Plan"><span class="text-danger fa fa-cog fa-spin "></span> Modificar-Real:</h3>
					</div>
					<div class="col-md-3 text-center text-md-right mb-1">
						<a href="usuario_real.php" class="btn btn-danger text-light p-1"><span class="fa fa-reply-all"></span> Volver</a>
					</div>
				...
				<form action="usuario_real.php" method="post" class="text-center bg-dark p-2 rounded">
					...
					<div class="row">
						...
						<div class="col-4">
							<div class="input-group">
								<span class="input-group-text w-100 rounded-0">Cantidad:</span>
								<input type="number" class="form-control col mb-2 rounded-0" name="cantidad" id="cantidad" placeholder="Año del ejercicio" required autocomplete="off" title="introduzca la cantidad de Unidades reales que desea reportar" min="1" value="<?php echo $datos_a_actualizar['CANTIDAD'] ?>">
							</div>
						</div>
						<div class="col-4">
							<div class="input-group">
					...
					<div class="m-auto">
						<a href="usuario_real.php" class="btn btn-danger text-light"><span class="fa fa-reply-all"></span> Volver</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Modificar Renglón &raquo;" class="btn btn-danger">
					</div>
				</form>
			</div>
		<?php
		...
		?>
				<META HTTP-EQUIV="Refresh" CONTENT="0; URL=usuario_real.php">
		<?php
			}
		...
		<div class="card mb-3">
			<div class="card-header text-center bg-transparent">
				<h3 class='text-center'><span class="text-danger fa fa-cog fa-spin"></span> Estas son las Actividades Reales para su Cargo Actual:</h3>
			</div>
			<?php
					...
					<table class="table table-bordered table-hover" id="dataTable01">
						<thead>
							<tr class="text-center">
								...
								<th class="align-middle h5 p-0"><a title="Insertar" href="usuario_real.php?NA_Accion=insertar" class="h3 btn btn-transparent text-primary fa fa-share-square-o"><br>Insertar</a></th>
							</tr>
						</thead>
						<tbody>
							<?php
							...
							<tr>
								...
								<td class="text-center h5"><a title="Modificar" href="usuario_real.php?NA_Accion=actualizar&NA_Id=<?php echo $datos['ID'][$i]; ?>" class="h3 btn btn-transparent text-success fa fa-edit d-inline"></a>&nbsp;&nbsp;<a title="Eliminar" href="usuario_real.php?NA_Accion=borrar&NA_Id=<?php echo $datos['ID'][$i]; ?>" class="btn btn-transparent text-danger fa fa-trash-o d-inline" onclick="return confirmar<?php echo $i; ?>('usuario_real?NA_Accion=borrar&NA_Id=<?php echo $datos['ID'][$i]; ?>')"></a></td>
								<script>
