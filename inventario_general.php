...
<body>
	...
	<section id="content" class="container-fluid text-justify">
		<!---------- FILTROS ---------->
		<form action="inventario_general.php" method="post" class="text-center bg-dark p-2 my-1 rounded">
			...
			<div class="row">
				<div class="col-md-4 mb-2">
						...
						<select class="form-control col rounded-0" name="gerencia" id="gerencia" required autocomplete="off" title="Indique la Gerencia a Mostrar">
				...
				<div class="col-md-4 mb-2">
					<div class="input-group">
						...
						<select class="form-control col rounded-0" name="departamento" id="departamento" required autocomplete="off" title="Indique el departamento a Mostrar">
